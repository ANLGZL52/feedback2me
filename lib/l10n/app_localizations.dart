...
class L10n {
  ...
  static const Map<String, String> _en = {
    ...
    'loginPrivacyNote': 'Secure & private. Your data is protected.',
    // V2 redesign
    'homeGreeting': 'Hi 👋',
    'homeHeroTitle': 'Real feedback,\none simple link.',
    'homeHeroSubtitle':
        'Create your link, share it and see what people really think.',
    'homeCreateCardTitle': 'Create your feedback link',
    'homeCreateCardDesc': 'Set up your profile, generate your link and share.',
    'homeWriteCardTitle': 'Write feedback from a link',
    'homeWriteCardDesc': 'Got a feedback link? Leave a comment.',
    'howItWorks': 'How it works?',
    'stepCreate': 'Create link',
    'stepShare': 'Share',
    'stepCollect': 'Collect feedback',
    'stepSummary': 'See AI summary',
    'trustAnonymous': 'Anonymous',
    'trustFast': 'Fast',
    'trustSecure': 'Secure',
    'homeWelcomeBack': 'Welcome back 👋',
    'homeWhatToDo': 'What would you like to do?',
    'createLinkTitle': 'Create Link',
    'createLinkV2Heading': 'Create a new link',
    'createLinkV2Sub': 'Pick the option that fits you.',
    'tierDemo': 'Demo',
    'tierFree': 'Free',
    'tierDemoF1': '10 minutes',
    'tierDemoF2': '1 feedback',
    'tierDemoF3': 'Great for a quick try',
    'tierPremium': 'Premium',
    'tierPaid': 'Paid',
    'tierPremiumF1': '24 hours',
    'tierPremiumF2': 'Multiple feedback',
    'tierPremiumF3': 'AI community summary',
    'createMyLink': 'Create My Link',
    'homeNoFeedbackYet': 'No feedback yet. Share your link to get the first one.',
    ...
    'homeLinkActive': 'Your link is active',
    'activeLinkExistsTitle': 'Active link exists',
    'activeLinkExistsBody': 'You already have an active link collecting comments. Are you sure you want to create a new one?',
    'activeLinkExistsConfirm': 'Create anyway',
    'creditPurchasedCreateLink': 'Credit added! You can now create a link.',
    ...
    'poolActiveLink': 'Active link: {n} comments received',
    'poolNoActiveLink': 'No active link',
    'poolNoActiveLinkHint': 'Create a new link to start collecting comments.',
    'poolCollecting': 'Comments are being collected... You can run analysis after the link expires.',
    'poolExpiredLink': 'Link expired — {n} comments received',
    'poolExpiredReady': 'Comment collection period is over. You can now run the AI analysis.',
    'poolExpiredNoComments': 'Link expired but no comments were received.',
    ...
    'simpleSummaryTitle': 'Takeaways from comments',
    'simpleSummaryCommentsCount': '{count} comments',
    'simpleSummaryPeopleWord': 'people',
    'simpleSummaryOther': 'Other takeaways ({count})',
    'simpleSummaryEmpty': 'No comments yet.',
    'simpleSummaryLowSignal':
        'Nothing repeated more than once yet — here is everything so far.',
    'detailedReportOpen': 'See detailed report',
    'liveSummaryTitle': 'Live summary — takeaways from comments',
    'expiredSummaryTitle': 'Your link expired — final summary ready',
    'expiredSummaryPreparing': 'Preparing your summary…',
    'expiredSummaryError': "Couldn't prepare the summary.",
    'summaryPreviewLine': 'Top: {count} {people} — {label}',
    'summaryPreviewNone': '{count} comments processed — tap to view',
    'expiredSummaryOpen': 'See summary',
    'homeSummaryHint':
        'When your time is up, your comments get a simple, friendly summary.',
    'warmHeadlinePositive': 'People mostly see you positively 💛',
    'warmHeadlineMixed': 'Valuable feedback here — room to grow 🌱',
    'warmHeadlineNeutral': 'Your comments are in — here are the highlights ✨',
    'analyzeLink': 'Analyze',
  ...
  static const Map<String, String> _tr = {
    ...
    'loginPrivacyNote': 'Güvenli ve gizli. Verilerin korunur.',
    // V2 redesign
    'homeGreeting': 'Merhaba 👋',
    'homeHeroTitle': 'Gerçek geri bildirim,\ntek bir linkte.',
    'homeHeroSubtitle':
        'Linkini oluştur, paylaş ve insanların gerçekten ne düşündüğünü gör.',
    'homeCreateCardTitle': 'Kendi feedback linkini oluştur',
    'homeCreateCardDesc': 'Profilini oluştur, linkini üret ve paylaş.',
    'homeWriteCardTitle': 'Gelen linkten feedback yaz',
    'homeWriteCardDesc': 'Sana bir feedback linki mi geldi? Yorum bırak.',
    'howItWorks': 'Nasıl çalışır?',
    'stepCreate': 'Link oluştur',
    'stepShare': 'Paylaş',
    'stepCollect': 'Feedback topla',
    'stepSummary': 'AI özetini gör',
    'trustAnonymous': 'Anonim',
    'trustFast': 'Hızlı',
    'trustSecure': 'Güvenli',
    'homeWelcomeBack': 'Hoş geldin 👋',
    'homeWhatToDo': 'Ne yapmak istersin?',
    'createLinkTitle': 'Link Oluştur',
    'createLinkV2Heading': 'Yeni link oluştur',
    'createLinkV2Sub': 'İhtiyacına uygun seçeneği seç.',
    'tierDemo': 'Demo',
    'tierFree': 'Ücretsiz',
    'tierDemoF1': '10 dakika',
    'tierDemoF2': '1 feedback',
    'tierDemoF3': 'Denemek için ideal',
    'tierPremium': 'Premium',
    'tierPaid': 'Ücretli',
    'tierPremiumF1': '24 saat',
    'tierPremiumF2': 'Çoklu feedback',
    'tierPremiumF3': 'AI topluluk özeti',
    'createMyLink': 'Linkimi Oluştur',
    'homeNoFeedbackYet': 'Henüz feedback yok. İlk yorumu almak için linkini paylaş.',
    ...
    'homeLinkActive': 'Linkin aktif',
    'activeLinkExistsTitle': 'Aktif link mevcut',
    'activeLinkExistsBody': 'Zaten yorum toplayan aktif bir linkin var. Yeni link oluşturmak istediğine emin misin?',
    'activeLinkExistsConfirm': 'Yine de oluştur',
    'creditPurchasedCreateLink': 'Kredi eklendi! Şimdi link oluşturabilirsin.',
    ...
    'poolActiveLink': 'Aktif link: {n} yorum geldi',
    'poolNoActiveLink': 'Aktif link yok',
    'poolNoActiveLinkHint': 'Yorum toplamaya başlamak için yeni link oluştur.',
    'poolCollecting': 'Yorumlar toplanıyor... Süre dolduktan sonra analiz yapabilirsin.',
    'poolExpiredLink': 'Süre doldu — {n} yorum geldi',
    'poolExpiredReady': 'Yorum toplama süresi bitti. Şimdi AI analizini başlatabilirsin.',
    'poolExpiredNoComments': 'Süre doldu ama hiç yorum gelmedi.',
    ...
    'viewAllComments': 'Tüm {n} yorumu gör',
    'allCommentsTitle': 'Tüm yorumlar',
    'aiAudienceAnalysisRun': 'AI Takipçi Yorum Analizi Oluştur',
    'simpleSummaryTitle': 'Yorumlardan çıkarımlar',
    'simpleSummaryCommentsCount': '{count} yorum',
    'simpleSummaryPeopleWord': 'kişi',
    'simpleSummaryOther': 'Diğer çıkarımlar ({count})',
    'simpleSummaryEmpty': 'Henüz yorum yok.',
    'simpleSummaryLowSignal':
        'Henüz birden fazla kez tekrarlanan bir şey yok — şu ana kadarki çıkarımlar aşağıda.',
    'detailedReportOpen': 'Detaylı raporu gör',
    'liveSummaryTitle': 'Canlı özet — yorumlardan çıkarımlar',
    'expiredSummaryTitle': 'Linkinin süresi doldu — final özetin hazır',
    'expiredSummaryPreparing': 'Özetin hazırlanıyor…',
    'expiredSummaryError': 'Özet hazırlanamadı.',
    'summaryPreviewLine': 'Öne çıkan: {count} {people} — {label}',
    'summaryPreviewNone': '{count} yorum işlendi — görmek için dokun',
    'expiredSummaryOpen': 'Özeti gör',
    'homeSummaryHint':
        'Süre bitince yorumların basit ve keyifli bir şekilde özetlenecek.',
    'warmHeadlinePositive': 'İnsanlar seni çoğunlukla olumlu görüyor 💛',
    'warmHeadlineMixed': 'Değerli geri bildirimler var — birlikte büyüme fırsatı 🌱',
    'warmHeadlineNeutral': 'Yorumların toplandı, işte öne çıkanlar ✨',
    'analyzeLink': 'Analiz yap',
