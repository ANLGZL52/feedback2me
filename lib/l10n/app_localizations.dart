...
class L10n {
  ...
  static const Map<String, String> _en = {
    ...
    // V2 — Link Created
    'linkCreatedV2Title': 'Your link is ready! 🎉',
    'linkCreatedV2Sub': 'Share it and start collecting feedback.',
    // V2 — Public feedback flow
    'pfEntryHeroGeneric': 'Your honest feedback is valuable.',
    'pfEntrySub': 'You can stay anonymous. Takes about 30 seconds.',
    'pfEntryStart': 'Start Feedback',
    'pfReactionTitle': "What's your first impression?",
    'pfStepReaction': 'Reaction',
    'pfStepComment': 'Comment',
    'pfCommentTitle': 'What stood out the most?',
    'pfCommentSub': 'Leave a short comment.',
    'pfCommentPlaceholder': 'Write the first thing that comes to mind…',
    'pfNameLabel': 'Your name (optional)',
    'pfNameHelper': 'Leave empty to stay anonymous.',
    'pfPrivacyFooter': 'Your feedback is shared anonymously.',
    'pfNext': 'Continue',
    'pfMinCharsHint': 'At least 10 characters.',
    'pfSuccessTitle': 'Thank you! 🎉',
    ...
    'forceUpdateTitle': 'A new version is available',
    'forceUpdateBody':
        'A new version of Feedback2Me is available. Update the app to keep creating feedback links.',
    'forceUpdateCta': 'Update app',
    ...
    'pfManualTitle': 'Paste the feedback link',
    'pfManualSub': 'Paste the link or code you received.',
    'pfManualContinue': 'Continue',
    // V2 — Community insights
    'insightCrowdScore': 'Crowd score',
    'insightBasedOn': 'Based on {n} real responses.',
    'insightWhatCrowdSays': 'What the crowd says?',
    'insightCollecting': 'First impressions are coming in 🙂',
    'insightLowConfidence':
        'Note: only a little feedback so far — give it time for a clearer read.',
    'insightSentiment': 'Sentiment',
    'insightNeedsWork': 'Needs work',
    'insightMostLoved': 'What people love ❤️',
    'insightMostMentioned': 'Most mentioned 👀',
    'insightSplit': 'Split opinions ⚖️',
    'insightHotTake': 'Hot Take',
    'insightSeeComments': 'See real comments',
    'moodOverallPositive': 'Positive',
    'moodOverallMixed': 'Mixed',
    'moodOverallNeutral': 'Neutral',
    'moodOverallNegative': 'Needs work',
    'insightLoadingTitle': 'Summarizing what the crowd said…',
    'insightLoadingSub': 'Grouping real comments into shared themes.',
    'insightErrorTitle': "Couldn't prepare the summary right now",
    'insightInsufficientTitle': 'A little more feedback needed',
    'insightInsufficientBody':
        'Collect a few more real responses to build a community summary.',
    'commentsTitle': 'Real Comments',
    'commentsCount': '{n} feedback',
    'commentAnonymous': 'Anonymous',
    'filterAll': 'All',
    'commentsEmptyTitle': 'No feedback yet',
    'commentsEmptyBody': "When the first comment arrives, you'll see it here.",
    'commentsFilterEmpty': 'No feedback in this filter',
    'pfExtraInfo': 'Extra info',
    'csProduction': 'Production',
    'csClarity': 'Clarity',
    'csTrust': 'Trust',
    'csEngagement': 'Engagement',
    'csConsistency': 'Consistency',
    // V2 — Profile + Link History
    'profileV2Credits': '{n} link credits',
    'profileV2Links': 'My Links',
    'profileV2Reports': 'Reports',
    'profileV2TotalLinks': 'Links',
    'profileV2TotalFeedback': 'Feedback',
    'profileV2ActiveLinks': 'Active',
    'profileV2Active': 'Active',
    'profileV2Completed': 'Completed',
    'profileV2ViewSummary': 'Summary',
    'profileV2ViewComments': 'Comments',
    'profileV2NoLinksTitle': "You don't have a link yet",
    'profileV2NoLinksBody': 'Start by creating your first feedback link.',
    'profileV2LinksError': 'Your links could not be loaded',
    'profileV2SignedOutTitle': 'Sign in to see your profile',
    ...
    'premiumYourLinks': 'Your links',
    'premiumLinkExpired': 'Expired',
    ...
    'premiumV2CreditSingular': 'Link Credit',
    ...
    'homeLegacyHeading': 'Your older link is still open',
    'homeLegacyNote': 'This is an old link (no time limit). Create a fresh premium link anytime.',
    'homeLinkPremium': 'Premium link',
    'homeLinkDemo': 'Demo link',
    'homeLinkLegacy': 'Older link',
    'homeCreditsLabel': 'Link credits',
    'homeNewLinkUsesCredit': 'Uses 1 credit',
    'homeCreatePremiumCta': 'Create premium link (1 credit)',
    'homeBuyCreditsCta': 'Get a link credit',
    'creditAddedToast': '+1 link credit added',
    'agoJustNow': 'just now',
    'agoSuffix': 'ago',
    'agoMin': 'min',
    'agoHour': 'h',
    ...
    'audienceAppBarTitle': 'Community Summary',
    'summaryV3FirstImpression': 'First impression',
    'summaryV3HowTheySeeYou': 'How people see you 👀',
    'summaryV3GrowthAreas': 'A few things you could work on 👀',
    'summaryV3ThreeWords': 'You in three words 🧩',
    'summaryV3RealHotTake': 'From a real feedback.',
    'summaryV3InsufficientImpression':
        "There isn't enough feedback yet to form a shared impression. This will become clearer as more feedback comes in.",
  ...
  static const Map<String, String> _tr = {
    ...
    // V2 — Link Created
    'linkCreatedV2Title': 'Linkin hazır! 🎉',
    'linkCreatedV2Sub': 'Paylaş ve feedback toplamaya başla.',
    // V2 — Public feedback akışı
    'pfEntryHeroGeneric': 'Dürüst feedback\'in çok değerli.',
    'pfEntrySub': 'Anonim kalabilirsin. Yaklaşık 30 saniye sürer.',
    'pfEntryStart': 'Geri Bildirime Başla',
    'pfReactionTitle': 'İlk izlenimin ne?',
    'pfStepReaction': 'Tepki',
    'pfStepComment': 'Yorum',
    'pfCommentTitle': 'En çok ne dikkatini çekti?',
    'pfCommentSub': 'Kısa bir yorum bırak.',
    'pfCommentPlaceholder': 'Aklına gelen ilk şeyi yaz…',
    'pfNameLabel': 'Adın (isteğe bağlı)',
    'pfNameHelper': 'Boş bırakırsan anonim görünürsün.',
    'pfPrivacyFooter': 'Feedback\'in anonim olarak paylaşılır.',
    'pfNext': 'Devam',
    'pfMinCharsHint': 'En az 10 karakter.',
    'pfSuccessTitle': 'Teşekkürler! 🎉',
    ...
    'forceUpdateTitle': 'Yeni sürüm hazır',
    'forceUpdateBody':
        'Feedback2Me\'nin yeni sürümü hazır. Link oluşturmaya devam etmek için uygulamayı güncelle.',
    'forceUpdateCta': 'Uygulamayı güncelle',
    ...
    'pfManualTitle': 'Feedback linkini yapıştır',
    'pfManualSub': 'Sana gelen linki ya da kodu buraya yapıştır.',
    'pfManualContinue': 'Devam',
    // V2 — Topluluk içgörüsü
    'insightCrowdScore': 'Topluluk skoru',
    'insightBasedOn': '{n} gerçek feedback\'ten oluşturuldu.',
    'insightWhatCrowdSays': 'Topluluk ne diyor?',
    'insightCollecting': 'İlk izlenimler toplanıyor 🙂',
    'insightLowConfidence':
        'Not: Henüz az yorum var — daha net sonuç için biraz bekle.',
    'insightSentiment': 'Duygu Dağılımı',
    'insightNeedsWork': 'Geliştirmeli',
    'insightMostLoved': 'İnsanların sevdiği ❤️',
    'insightMostMentioned': 'En çok konuşulan 👀',
    'insightSplit': 'İkiye bölünenler ⚖️',
    'insightHotTake': 'Hot Take',
    'insightSeeComments': 'Gerçek yorumları gör',
    'moodOverallPositive': 'Olumlu',
    'moodOverallMixed': 'Karışık',
    'moodOverallNeutral': 'Nötr',
    'moodOverallNegative': 'Geliştirmeli',
    'insightLoadingTitle': 'Topluluğun söylediklerini özetliyoruz…',
    'insightLoadingSub': 'Gerçek yorumları ortak temalar halinde grupluyoruz.',
    'insightErrorTitle': 'Özet şu anda hazırlanamadı',
    'insightInsufficientTitle': 'Biraz daha feedback gerekiyor',
    'insightInsufficientBody':
        'Topluluk özeti oluşturmak için birkaç gerçek görüş daha topla.',
    'commentsTitle': 'Gerçek Yorumlar',
    'commentsCount': '{n} feedback',
    'commentAnonymous': 'Anonim',
    'filterAll': 'Tümü',
    'commentsEmptyTitle': 'Henüz feedback yok',
    'commentsEmptyBody': 'İlk yorum geldiğinde burada görebileceksin.',
    'commentsFilterEmpty': 'Bu filtrede feedback yok',
    'pfExtraInfo': 'Ek bilgiler',
    'csProduction': 'Üretim',
    'csClarity': 'Netlik',
    'csTrust': 'Güven',
    'csEngagement': 'İlgi',
    'csConsistency': 'Tutarlılık',
    // V2 — Profil + Link Geçmişi
    'profileV2Credits': '{n} link kredisi',
    'profileV2Links': 'Linklerim',
    'profileV2Reports': 'Raporlar',
    'profileV2TotalLinks': 'Link',
    'profileV2TotalFeedback': 'Feedback',
    'profileV2ActiveLinks': 'Aktif',
    'profileV2Active': 'Aktif',
    'profileV2Completed': 'Tamamlandı',
    'profileV2ViewSummary': 'Özet',
    'profileV2ViewComments': 'Yorumlar',
    'profileV2NoLinksTitle': 'Henüz linkin yok',
    'profileV2NoLinksBody': 'İlk feedback linkini oluşturarak başlayabilirsin.',
    'profileV2LinksError': 'Linklerin yüklenemedi',
    'profileV2SignedOutTitle': 'Profilini görmek için giriş yap',
    'profileV2SignedOutBody':
    ...
    'premiumYourLinks': 'Linklerin',
    'premiumLinkExpired': 'Süresi doldu',
    ...
    'premiumV2PremiumLink': 'Premium Link',
    'premiumV2CreditSingular': 'link kredisi',
    // V2 — Splash + Onboarding
    ...
    'homeLegacyHeading': 'Eski linkin hâlâ açık',
    'homeLegacyNote': 'Bu eski bir link (süre sınırı yok). İstediğin zaman yeni bir premium link oluşturabilirsin.',
    'homeLinkPremium': 'Premium link',
    'homeLinkDemo': 'Demo link',
    'homeLinkLegacy': 'Eski link',
    'homeCreditsLabel': 'Link kredin',
    'homeNewLinkUsesCredit': '1 kredi harcanır',
    'homeCreatePremiumCta': 'Premium link oluştur (1 kredi)',
    'homeBuyCreditsCta': 'Link kredisi al',
    'creditAddedToast': '+1 link kredisi eklendi',
    'agoJustNow': 'az önce',
    'agoSuffix': 'önce',
    'agoMin': 'dk',
    'agoHour': 'sa',
    ...
    'audienceAppBarTitle': 'Topluluk Özeti',
    'summaryV3FirstImpression': 'İlk bakışta sen',
    'summaryV3HowTheySeeYou': 'Seni nasıl görüyorlar? 👀',
    'summaryV3GrowthAreas': 'Biraz geliştirebileceğin taraflar 👀',
    'summaryV3ThreeWords': 'Seni üç kelimeyle 🧩',
    'summaryV3RealHotTake': 'Gerçek bir feedback\'ten.',
    'summaryV3InsufficientImpression':
        'Henüz ortak bir izlenim oluşması için yeterli feedback yok. Daha fazla yorum geldikçe burası netleşecek.',
